...
<div class="padd20">
    <div class="pt10 pr20 pl20 pb10">
        ...
        <i class="rhicon <?php echo (is_rtl()) ? 'rhi-arrow-left' : 'rhi-arrow-right';?> rehub-main-color font130 whitehovered csstranstrans rh-hovered-rotate position-relative"></i>
