		...
		$lb_verify_res = array (
			...
			array (
			  ...
			  array (
				...
				'greenshift' => 'https://wpsoul.net/serverupdate/packages/greenshift.zip',
				...
				'rh-fake-acivity' => 'https://wpsoul.net/serverupdate/packages/rh-fake-activity.zip',
				...
				'rh-chart' => 'https://wpsoul.net/serverupdate/packages/rh-chart.zip',
				...
				'salenotification' => 'https://wpsoul.net/serverupdate/packages/xs-wc-live-sales-notifications.zip',
			  ),
			  'themes' => 
			  array (
				'ReViewit' => 
				...
				'ReLearn' => 
				array (
				  'content' => 'https://wpsoul.net/serverupdate/demoimport/relearns-content.xml',
				  'widgets' => 'https://wpsoul.net/serverupdate/demoimport/relearn-widgets.wie',
				  'frontend' => '',
				  'gmwforms' => '',
				),
				'ReDigit' => 
				array (
				  'content' => 'https://wpsoul.net/serverupdate/demoimport/redigit-content.xml',
				  'widgets' => 'https://wpsoul.net/serverupdate/demoimport/redigit-widgets.wie',
				  'frontend' => '',
				  'gmwforms' => '',
				),
				'ReMag' => 
