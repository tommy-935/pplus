<?php
	...
	if ( comments_open() ) {
		...
		echo '<h3 class="cz_cm_ttl">';
			...
			comments_number( 
				do_shortcode( Xtra_Theme::option( 'no_comment', Xtra_Strings::get( 'no_comment' ) ) ), 
				'1 ' . do_shortcode( Xtra_Theme::option( 'comment', Xtra_Strings::get( 'comment' ) ) ), 
				'% ' . do_shortcode( Xtra_Theme::option( 'comments', Xtra_Strings::get( 'comments' ) )  )
			);
